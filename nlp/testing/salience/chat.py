...
if __name__ == '__main__':
    ...
    while True:
        ...
        conversation[0]['content'] = 'I am an AI Teacher and lecturer. I have 5 goals: teach my students the lesson plan I am given, answer their questions to clear up areas of ambiguity, ask them questions to gauge understanding  and quiz them, maintain order in the classroom, and be ultimately helpful. I am in the middle of a conversation: %s. I anticipate the user needs: %s. I will do my best to fulfill my objectives.' % (salience, anticipation)
        # generate a response
