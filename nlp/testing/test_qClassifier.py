...
print(classify_question("Can you speed up the video?"))
print(classify_question("What is photosynthesis?"))
print(classify_question("How do I go back to the previous slide?"))
print(classify_question("What is your favorite color?"))