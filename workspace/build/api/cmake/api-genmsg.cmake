...
set(MSG_I_FLAGS "-Iapi:/home/matt/Desktop/RoboLecturer-Code/workspace/src/api/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/matt/Desktop/RoboLecturer-Code/workspace/src/api/msg/CVInfo.msg" NAME_WE)
add_custom_target(_api_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "api" "/home/matt/Desktop/RoboLecturer-Code/workspace/src/api/msg/CVInfo.msg" ""
)
...
_generate_msg_cpp(api
  "/home/matt/Desktop/RoboLecturer-Code/workspace/src/api/msg/CVInfo.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/api)
  install(CODE "execute_process(COMMAND \"/home/matt/miniconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/api\")")
  # install generated code
  install(
